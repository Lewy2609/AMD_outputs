...
strace -c -S name -f -o >(cat >> strace_output_combined_1T_1C_44_threads.txt) numactl  --physcpubind=8,9,10,11,12,13,14,15,24,25,26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 44 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_44.txt
...
strace -c -S name -f -o >(cat >> strace_output_combined_1T_1C_52_threads.txt) numactl  --physcpubind=8,9,10,11,12,13,14,15,24,25,26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 52 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_52.txt
...
python strace_output_to_csv.py