...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 2 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_2.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 2 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_2.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 2 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_2.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 2 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_2.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 4 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_4.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 4 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_4.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 4 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_4.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 4 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_4.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 8 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_8.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 8 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_8.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 8 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_8.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 8 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_8.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 12 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_12.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 12 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_12.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 12 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_12.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 12 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_12.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 16 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_16.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 16 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_16.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 16 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_16.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 16 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_16.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 20 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_20.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 20 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_20.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 20 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_20.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 20 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_20.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 24 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_24.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 24 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_24.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 24 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_24.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 24 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_24.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 28 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_28.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 28 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_28.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 28 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_28.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 28 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_28.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 32 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_32.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 32 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_32.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 32 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_32.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 32 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_32.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 36 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_36.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 36 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_36.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 36 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_36.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 36 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_36.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 40 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_40.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 40 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_40.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 40 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_40.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 40 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_40.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 56 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_56.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 56 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_56.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 56 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_56.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 56 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_56.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 60 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_60.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 60 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_60.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 60 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_60.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 60 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_60.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 64 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_64.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 64 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_64.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 64 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_64.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 64 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_64.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 68 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_68.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 68 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_68.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 68 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_68.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 68 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_68.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 72 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_72.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 72 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_72.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 72 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_72.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 72 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_72.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 76 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_76.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 76 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_76.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 76 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_76.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 76 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_76.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 80 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_80.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 80 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_80.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 80 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_80.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 80 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_80.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 84 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_84.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 84 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_84.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 84 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_84.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 84 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_84.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 88 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_88.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 88 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_88.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 88 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_88.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 88 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_88.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 92 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_92.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 92 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_92.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 92 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_92.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 92 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_92.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 96 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_96.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 96 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_96.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 96 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_96.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 96 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_96.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
...
do
        ...
        numactl --physcpubind=4,5,6,7,8,9 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 100 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p1_100.txt 2>> logs.txt &
        pid1=$!
        echo "PID1 = $pid1"

        numactl --physcpubind=10,11,12,13,14,15 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 100 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p2_100.txt 2>> logs.txt &
        pid2=$!
        echo "PID2 = $pid2"

        numactl --physcpubind=20,21,22,23,24,25 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable1 -threads 100 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p3_100.txt 2>> logs.txt &
        pid3=$!
        echo "PID3 = $pid3"

        numactl --physcpubind=26,27,28,29,30,31 ./bin/ycsb run mongodb -s -P workloads/workloada -p recordcount=10000000 -p operationcount=1000000 -p table=usertable2 -threads 100 -p requestdistribution=zipfian -p mongodb.url=mongodb://localhost:27017/ycsb?w=0 >> p4_100.txt 2>> logs.txt &
        pid4=$!
        echo "PID4 = $pid4"
